...
func NewCache(gcInterval time.Duration) *Cache { _ = "STUB: not implemented"; return nil }

// Remove jobs and timeseries that have aged out.
func (c *Cache) gc() { _ = "STUB: not implemented"; return }
...
func (c *Cache) MaybeGC() { _ = "STUB: not implemented"; return }
