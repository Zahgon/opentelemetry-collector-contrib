...
func WithEnumParser[K any](parser EnumParser) Option[K] { _ = "STUB: not implemented"; return nil }
...
func parseValueExpression(raw string) (*value, error) { _ = "STUB: not implemented"; return nil, nil }
...
func newParser[G any]() *participle.Parser[G] { _ = "STUB: not implemented"; return nil }

// Allows negative lookahead to work properly in 'value' for 'mathExprLiteral'.
