...
func (av AttributeStatus) String() string { _ = "STUB: not implemented"; return "" }
...
func (m *metricSystemProcessesCount) updateCapacity() { _ = "STUB: not implemented"; return }
...
func newMetricSystemProcessesCount(cfg SystemProcessesCountMetricConfig) metricSystemProcessesCount {
	_ = "STUB: not implemented"
	return *new(metricSystemProcessesCount)
}
...
// updateCapacity saves max length of data point slices that will be used for the slice capacity.
func (m *metricSystemProcessesCreated) updateCapacity() { _ = "STUB: not implemented"; return }
...
func newMetricSystemProcessesCreated(cfg SystemProcessesCreatedMetricConfig) metricSystemProcessesCreated {
	_ = "STUB: not implemented"
	return *new(metricSystemProcessesCreated)
}
