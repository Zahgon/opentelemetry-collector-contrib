...
func (m *metricSystemCPULoadAverage15m) updateCapacity() { _ = "STUB: not implemented"; return }
...
func newMetricSystemCPULoadAverage15m(cfg SystemCPULoadAverage15mMetricConfig) metricSystemCPULoadAverage15m {
	_ = "STUB: not implemented"
	return *new(metricSystemCPULoadAverage15m)
}
...
// updateCapacity saves max length of data point slices that will be used for the slice capacity.
func (m *metricSystemCPULoadAverage1m) updateCapacity() { _ = "STUB: not implemented"; return }
...
func newMetricSystemCPULoadAverage1m(cfg SystemCPULoadAverage1mMetricConfig) metricSystemCPULoadAverage1m {
	_ = "STUB: not implemented"
	return *new(metricSystemCPULoadAverage1m)
}
...
// updateCapacity saves max length of data point slices that will be used for the slice capacity.
func (m *metricSystemCPULoadAverage5m) updateCapacity() { _ = "STUB: not implemented"; return }
...
func newMetricSystemCPULoadAverage5m(cfg SystemCPULoadAverage5mMetricConfig) metricSystemCPULoadAverage5m {
	_ = "STUB: not implemented"
	return *new(metricSystemCPULoadAverage5m)
}
